...
superADMM_solve_problem: Optional[
    Callable[
        [
            Problem,
            Optional[ndarray],
...
try:
    from .superadmm_ import superadmm_solve_problem, superadmm_solve_qp

    solve_function["superADMM"] = superadmm_solve_problem
    available_solvers.append("superADMM")
    sparse_solvers.append("superADMM")
except ImportError:
    pass
